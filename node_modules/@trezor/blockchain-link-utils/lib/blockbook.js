...
const transformTransaction = (tx, addressesOrDescriptor) => {
    ...
    const fee = tx.ethereumSpecific && !tx.ethereumSpecific.gasUsed
        ? new bignumber_js_1.default((_d = (_c = tx.ethereumSpecific) === null || _c === void 0 ? void 0 : _c.gasPrice) !== null && _d !== void 0 ? _d : '0')
...
const transformAccountInfo = (payload) => {
    ...
    return {
        ...
        misc,
        page,
        stakingPools: payload === null || payload === void 0 ? void 0 : payload.stakingPools,
    };
};
