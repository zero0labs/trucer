...
export declare const transformTransaction: (tx: SolanaValidParsedTxWithMeta, accountAddress: string, tokenAccountsInfos: SolanaTokenAccountInfo[]) => Promise<Transaction>;
export {};
