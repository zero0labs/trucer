...
const SOLANA_TOKEN_LIST_URL = 'https://cdn.jsdelivr.net/gh/viaprotocol/tokenlists/all_tokens/solana.json';
const LOCAL_TOKEN_METADATA = {
...
const getTokenMetadata = () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const tokenListResult = yield (yield fetch(SOLANA_TOKEN_LIST_URL)).json();
    const tokenMap = tokenListResult.reduce((acc, token) => (Object.assign({ [token.address]: {
            name: token.name,
            symbol: token.symbol,
        } }, acc)), {});
    tokenMap[exports.WSOL_MINT].symbol = 'WSOL';
    return Object.assign(Object.assign({}, LOCAL_TOKEN_METADATA), tokenMap);
});
...
const transformTransaction = (tx, accountAddress, tokenAccountsInfos) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
